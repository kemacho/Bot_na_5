...
bot_commands = (
    ...
    ("add", "Добавление папки в отслеживаемые для учеников (только для преподавателей)"),
    ("delete", "Удаление папки из отслеживаемых для учеников (только для преподавателей)")
)
